...
import { updateProfile, updateStateComplex, updateStateOuter, updateStateSimple } from "../../redux/navbarStatusSlice";
...
import { BsChevronDown, BsHeart, BsHeartFill, BsHouseDoor, BsHouseDoorFill, BsPlusSquare, BsPlusSquareFill } from "react-icons/bs";
...

                {
                    width < 650 ?
                        ...
                        <Grid item xs={3.5} className="navBar_search">
                            {
                                searchContent === '' ?
                                    <input type="text" placeholder="Tìm kiếm thông tin" className="navBar_inputFull" value={searchContent} onChange={handleSearchInputChange} onClick={e => e.nativeEvent.stopImmediatePropagation()}/>
                                    :
                                    <>
