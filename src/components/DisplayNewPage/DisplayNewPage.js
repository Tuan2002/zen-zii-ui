...
import {
    ...
    getLikesByPostId, getPostByPostId, getPostsById,
    likePost, savePost,
    unlikePost,
    unSavePost
} from "../../api";
    ...
    return (
        ...
        <div className="displayNew_container" onClick={() => {
                    ...
                    <div className="display_card_right_middle">
                        ...
                        {(postInfo.postCaption === null || postInfo.postCaption === '') && comments.length === 0 ?
                            <div style={{display:"flex", flexDirection:"column", justifyContent:"center", alignItems:"center", height:"100%"}}>
                                ...
                                <div style={{fontSize:"0.9rem"}}>Bắt đầu cuộc trò chuyện</div>
                            </div>
                            :
                            <div/>
                        }
                        ...
                        <div className="postCard_comment">
                            <div className="postCard_commentEmoji">
                                ...
                                <div className="textarea_container">
                                    <textarea id={"textArea_id2"} value={commentInput} placeholder="Viết bình luận..." className="postCard_commentInput" onChange={event => setCommentInput(event.target.value)}/>
                                </div>
                            </div>
                            {
                                commentInput === ''?
            ...
            <div style={{width:"65vw"}}>
                <div style={{fontSize:"0.9rem", color:"rgb(142,142,142)"}}>Các bài viết của <b style={{color:"black"}}>{postInfo.userName}</b></div>
            </div>
