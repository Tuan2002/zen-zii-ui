...
const NewPost = () => {
   ...
   const uploadImage = async () => {
    try {
        // Convert the HTML element to an image and get the data URL
        const dataUrl = await htmlToImage.toPng(imgParentRef.current);

        const result = await cloudinaryUpload(dataUrl);

        // Prepare post data with the Cloudinary URL
        const postData = {
            postIdentifier: uuidv4().split('-').pop(),
        ...
        <div style={{position:"relative"}} onClick={e=> e.nativeEvent.stopImmediatePropagation()}>
            ...
            <div className="newPost_container" onClick={handleDiscard}>
                <div className="newPost_create" style={{display:`${stage === 0 ? "block" : "none"}`}}
                    ...
                    <div className="newPost_title" >Tạo khoảnh khắc mới</div>
                    <div className="newPost_body" >
                        <img src={logoImg} />
                        <div style={{fontSize:"1.3rem"}}>Kéo thả ảnh hoặc video vào đây</div>
                ...
                <div className="newPost_create" style={{display:`${stage === 1 ? "block" : "none"}`}} onClick={e=> {
                    e.stopPropagation();
                      ...
                      <div className="newPost_title newPost_title_crop">
                          ...
                          <span>Cắt</span>
                          <span className="newPost_next" onClick={() => setStage(2)}>Tiếp tục</span>
                      </div>
                ...
                <div className="newPost_edit" style={{display:`${stage === 2 ? "block" : "none"}`}} onClick={e=> {
                    ...
                    <div className="newPost_title newPost_title_crop">
                        ...
                        <span>{captionStage? "Tạo bài viết": "Chỉnh sửa"}</span>
                        ...
                        }}>{captionStage? "Đăng": "Tiếp tục"}</span>
                    </div>
                        ...
                        </div>
                        {
                            captionStage?
                                <div className="newPost_editPhoto_caption">
                                    ...
                                    <div className="newPost_access"
                                        ...
                                        <div style={{display:`${accessOpen ? 'block':'none'}`}}>
                                            <div style={{margin:"0.8rem 0", fontSize:"0.8rem", color:"rgb(143,143,143)"}}>
                                                Văn bản mô tả hình ảnh sẽ được đọc bởi công nghệ hỗ trợ truy cập. Để biết thêm thông tin, hãy xem trang trợ giúp của chúng tôi.
                                            </div>
                                    ...
                                    >
                                        <div style={{display:"flex", justifyContent:"space-between"}}>
                                            <div style={{fontWeight:`${advancedOn? 'bold':'unset'}`}}>Cài đặt nâng cao</div>
                                            <div
                                                className="newPost_up_and_down"
                                        ...
                                        <div style={{display:`${advancedOn ? 'block':'none'}`}}>
                                            <div style={{display:"flex", alignItems:"spaceBetween"}} className="newPost_switch">
                                                <div style={{margin:"0.3rem 0"}}>Ẩn số lượt thích và xem bài viết này</div>
                                                <div><AntSwitch
                                            ...
                                            <div style={{fontSize:"0.8rem", color:"rgb(143,143,143)"}}>
                                                <div>
                                                    Chỉ bạn và người theo dõi của bạn sẽ thấy số lượt thích và lượt xem trên bài viết này, bạn có thể chỉnh sửa cài đặt này sau khi đăng bài.
                                                </div>
                                                <a className="newPost_href" target="_blank" href="https://help.instagram.com/113355287252104">Tìm hiểu thêm</a>
                                            </div>

                                            <div style={{display:"flex", alignItems:"spaceBetween"}} className="newPost_switch">
                                                <div style={{margin:"0.5rem 0"}}>Tắt chức năng bình luận</div>
                                                <div><AntSwitch
                                                    inputProps={{ 'aria-label': 'ant design' }}
